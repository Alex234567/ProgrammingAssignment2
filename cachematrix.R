...
## If the inverse has been calculated before, it will not be calculated again.
## Instead, the cached value will be used.


## makeCacheMatrix function creates a special "matrix", which contains 
